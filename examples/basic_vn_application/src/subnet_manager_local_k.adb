...
package body Subnet_Manager_Local_K is
   ...
   task body SM_L is
      ...
      -------------------------------
      Name     : aliased String := "SM_K ";
      SM_Logic : VN.SM_Application_Layer_Logic.SM_Logic_Type(
                        Global_Settings.Com_SM_K'Access,
                        Global_Settings.CUUID_SM_K'Access,
                        Name'Access,
