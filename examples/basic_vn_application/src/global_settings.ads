...
package Global_Settings is
   ...
   Com_SM_K : aliased VN.Communication.Protocol_Routing.Protocol_Routing_Type;
   ...
   PO_Router_SM_K: aliased VN.Communication.Protocol_Routing.Protocol_Routing_Type;
   ...
   -- SM-K
   PO_Wrapper_SM_X_To_SM_K: aliased VN.Communication.PO_Wrapper.VN_PO_Wrapper(
                                                            PO_To_SM_K'Access,
                                                            CUUID_SM_X'Access,
                                                            VN.Message.SM_L,
                                                            True);

   PO_Wrapper_SM_K_To_SM_X: aliased VN.Communication.PO_Wrapper.VN_PO_Wrapper(
                                                            PO_To_SM_K'Access,
                                                            CUUID_SM_K'Access,
                                                            VN.Message.SM_x,
                                                            False);
