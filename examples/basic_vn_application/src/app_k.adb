...
package body App_K is
   ...
   begin
      ...
      VN.Text_IO.Put_Line("APPK STAT: Starts.");
      ...
      loop
        ...
        if not VN_Logical_Address_Buffer.Empty(Probe_Reply_Buffer) then
            ...
            VN.Text_IO.Put("APPK SEND: ");
            Global_Settings.Logger.Log(Basic_Msg);
            Global_Settings.Com_App_K.Send(Basic_Msg, Send_Status);
      ...
      VN.Text_IO.Put_Line("APPK STAT: Stop. Logical Address: " &
