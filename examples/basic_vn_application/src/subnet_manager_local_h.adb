...
package body Subnet_Manager_Local_H is
   ...
   begin
      ...
      VN.Text_IO.Put_Line("SM-H STAT: Starts.");
               ...
               if (Local_Hello_Msg.Component_Type = VN.Message.Other or
                  ...
                  if Assign_Address_Block_Msg.Response_Type = VN.Message.Valid and
                     ...
                     Assign_Address_Block_Msg.CUUID /= Global_Settings.CUUID_SM_H then
                        ...
                        Global_Settings.Logger.Log(Basic_Msg);
                        Global_Settings.Com_SM_H.Send(Basic_Msg, Send_Status);
      ...
      VN.Text_IO.Put_Line("SM-H STAT: Stop. Logical Address: " &
